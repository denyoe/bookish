...
var getQuestions = function () { return __awaiter(_this, void 0, void 0, function () {
    var found;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models.Question.findAll({
                    include: [{
                            // all: true
                            model: models.Choice,
                            as: 'choices'
...
var getQuestionsByType = function (type) { return __awaiter(_this, void 0, void 0, function () {
    var found;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models.Choice.findAll({
                    where: { type: 'MCQ' }
                })];
            case 1:
                found = _a.sent();
